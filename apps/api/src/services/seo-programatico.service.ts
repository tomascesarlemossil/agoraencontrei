...
export const SEO_KEYWORDS: [string, string][] = [
  ...
  ['reforma de apartamentos', 'reforma'],
  ['reforma comercial', 'reforma'],
  ['reforma completa', 'reforma'],
  ['reforma de banheiro', 'reforma'],
  ['reforma de cozinha', 'reforma'],
  ['obras residenciais', 'reforma'],
  ['obras comerciais', 'reforma'],
  ['empreiteira', 'reforma'],
  ['mao de obra para construcao', 'reforma'],
  ['pedreiro', 'reforma'],
  ['servente de pedreiro', 'reforma'],
  ['mestre de obras', 'reforma'],
  ['empreiteiro', 'reforma'],
  ['orcamento de obra', 'reforma'],
  ['acabamento de obra', 'reforma'],
  ['drywall', 'reforma'],
  ['gesso', 'reforma'],
  ['pintura residencial', 'reforma'],
  ['eletrica residencial', 'reforma'],
  ['hidraulica residencial', 'reforma'],
  ['telhado', 'reforma'],
  ['impermeabilizacao', 'reforma'],
  ['fachada de casa', 'reforma'],
  ['demolicao', 'reforma'],
  ['terraplanagem', 'reforma'],
  ['custo de reforma', 'reforma'],
  ['preco de reforma', 'reforma'],
  // === ENGENHARIA ===
  ['engenheiro civil', 'engenharia'],
  ['escritorio de engenharia', 'engenharia'],
  ['calculo estrutural', 'engenharia'],
  ['projeto estrutural', 'engenharia'],
  ['laudo estrutural', 'engenharia'],
  ['vistoria tecnica', 'engenharia'],
  ['perito engenheiro', 'engenharia'],
  ['regularizacao de obra', 'engenharia'],
  ['art engenharia', 'engenharia'],
  ['habite-se', 'engenharia'],
  ['aprovacao de projeto', 'engenharia'],
  ['acompanhamento de obra', 'engenharia'],
  ['topografia', 'engenharia'],
  ['sondagem de solo', 'engenharia'],
  ['drenagem', 'engenharia'],
  ['contencao de encosta', 'engenharia'],
  ['fundacoes', 'engenharia'],
  ['usucapiao tecnico', 'engenharia'],
  ['georreferenciamento', 'engenharia'],
  ['laudo tecnico de imovel', 'engenharia'],
  // === ARQUITETURA ===
  ['arquiteto', 'arquitetura'],
  ['arquitetos', 'arquitetura'],
  ['escritorio de arquitetura', 'arquitetura'],
  ['projeto arquitetonico', 'arquitetura'],
  ['arquitetura residencial', 'arquitetura'],
  ['arquitetura comercial', 'arquitetura'],
  ['design de interiores', 'arquitetura'],
  ['projeto de interiores', 'arquitetura'],
  ['reforma com arquiteto', 'arquitetura'],
  ['aprovacao de projeto arquitetonico', 'arquitetura'],
  ['arquitetura de luxo', 'arquitetura'],
  ['fachada moderna', 'arquitetura'],
  ['projeto de condominio', 'arquitetura'],
  ['projeto de loteamento', 'arquitetura'],
  ['paisagismo', 'arquitetura'],
  ['area gourmet', 'arquitetura'],
  ['arquitetura alto padrao', 'arquitetura'],
  ['render arquitetonico', 'arquitetura'],
  ['maquete eletronica', 'arquitetura'],
  // === CONSTRUTORAS E INCORPORADORAS ===
  ['construtora', 'construtora'],
  ['construtoras', 'construtora'],
  ['incorporadora', 'construtora'],
  ['incorporacao imobiliaria', 'construtora'],
  ['empresa de construcao', 'construtora'],
  ['construtora de casas', 'construtora'],
  ['construtora de predios', 'construtora'],
  ['construtora de condominios', 'construtora'],
  ['lancamentos de construtoras', 'construtora'],
  ['construtora alto padrao', 'construtora'],
  ['construtora popular', 'construtora'],
  ['incorporadora de loteamento', 'construtora'],
  ['parceria para incorporacao', 'construtora'],
  ['areas para incorporacao', 'construtora'],
  ['areas para loteamento', 'construtora'],
  // === MATERIAIS DE CONSTRUCAO ===
  ['loja de material de construcao', 'materiais'],
  ['revestimentos', 'materiais'],
  ['pisos', 'materiais'],
  ['porcelanatos', 'materiais'],
  ['ceramicas', 'materiais'],
  ['portas de pvc', 'materiais'],
  ['portas de aluminio', 'materiais'],
  ['esquadrias de aluminio', 'materiais'],
  ['janelas', 'materiais'],
  ['box para banheiro', 'materiais'],
  ['marmoraria', 'materiais'],
  ['vidracaria', 'materiais'],
  ['serralheria', 'materiais'],
  ['moveis planejados', 'materiais'],
  ['iluminacao residencial', 'materiais'],
  ['tintas', 'materiais'],
  ['forros', 'materiais'],
  ['telhas', 'materiais'],
  ['cimento', 'materiais'],
  ['bloco de concreto', 'materiais'],
  ['ferragens', 'materiais'],
  ['granito e marmore', 'materiais'],
  ['deck de madeira', 'materiais'],
  // === GUIAS E COMPARATIVOS ===
  ['melhores bairros para morar', 'guia'],
  ['melhores bairros para investir', 'guia'],
  ['custo do metro quadrado', 'guia'],
  ['preco do metro quadrado', 'guia'],
  ['como comprar imovel em leilao', 'guia'],
  ['guia de compra de imovel', 'guia'],
  ['checklist compra de imovel', 'guia'],
  ['simulacao de financiamento', 'guia'],
  ['comparativo de bairros', 'guia'],
  ['custo de vida', 'guia'],
  ['bairros mais valorizados', 'guia'],
  ['tendencias do mercado imobiliario', 'guia'],
  ['como vender imovel rapido', 'guia'],
  ['como alugar rapido', 'guia'],
  ['documentacao para compra de imovel', 'guia'],
  ['impostos na compra de imovel', 'guia'],
  ['vantagens de morar', 'guia'],
  ['qualidade de vida', 'guia'],
  ['infraestrutura urbana', 'guia'],
  ['transporte publico', 'guia'],
  // === SERVICOS ESPECIALIZADOS ===
  ['vistoria de imovel', 'especializado'],
  ['laudo de avaliacao', 'especializado'],
  ['home staging', 'especializado'],
  ['fotografia de imoveis', 'especializado'],
  ['video de imoveis', 'especializado'],
  ['drone para imoveis', 'especializado'],
  ['tour virtual de imovel', 'especializado'],
  ['planta baixa', 'especializado'],
  ['memorial descritivo', 'especializado'],
  ['due diligence imobiliaria', 'especializado'],
  ['consultoria de investimento imobiliario', 'especializado'],
  ['gestao de patrimonio imobiliario', 'especializado'],
  // === MODIFICADORES LONG TAIL ===
  ['imovel direto com proprietario', 'modificador'],
  ['imovel sem entrada', 'modificador'],
  ['imovel aceita financiamento', 'modificador'],
  ['imovel aceita fgts', 'modificador'],
  ['imovel pronto para morar', 'modificador'],
  ['imovel na planta', 'modificador'],
  ['imovel em condominio fechado', 'modificador'],
  ['imovel com area de lazer', 'modificador'],
  ['imovel perto de escola', 'modificador'],
  ['imovel perto de hospital', 'modificador'],
  ['imovel perto de faculdade', 'modificador'],
  ['imovel perto do centro', 'modificador'],
  ['imovel perto de comercio', 'modificador'],
  ['imovel com piscina', 'modificador'],
  ['imovel com suite master', 'modificador'],
  ['imovel com home office', 'modificador'],
  ['imovel com energia solar', 'modificador'],
  ['imovel para airbnb', 'modificador'],
  ['imovel para temporada', 'modificador'],
  ['imovel para renda', 'modificador'],
]
