...
const jsonLdBusiness = {
  ...
  alternateName: ['Lemos Imóveis', 'AgoraEncontrei', 'Imobiliária Lemos', 'AgoraEncontrei Imobiliária Lemos'],
  description: 'AgoraEncontrei é o marketplace imobiliário da Imobiliária Lemos, referência em Franca/SP há mais de 22 anos. Plataforma com 1.000+ imóveis, busca por IA e mapa interativo. Casas, apartamentos, terrenos e imóveis comerciais para compra, venda e locação.',
  url: WEB_URL,
  ...
  areaServed: [
    ...
    { '@type': 'City', name: 'Pedregulho', containedInPlace: { '@type': 'State', name: 'São Paulo' } },
    { '@type': 'City', name: 'Orlândia', containedInPlace: { '@type': 'State', name: 'São Paulo' } },
    { '@type': 'City', name: 'São Joaquim da Barra', containedInPlace: { '@type': 'State', name: 'São Paulo' } },
    { '@type': 'City', name: 'Ibiraci', containedInPlace: { '@type': 'State', name: 'Minas Gerais' } },
    { '@type': 'City', name: 'Capetinga', containedInPlace: { '@type': 'State', name: 'Minas Gerais' } },
  ],
  hasMap: 'https://maps.google.com/?q=AgoraEncontrei+Imobiliária+Lemos+Franca+SP',
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Compra e Venda de Imóveis', description: 'Intermediação na compra e venda de casas, apartamentos, terrenos e imóveis comerciais em Franca/SP' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Locação de Imóveis', description: 'Aluguel residencial e comercial com administração completa' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Avaliação de Imóveis', description: 'Avaliação profissional gratuita por corretores credenciados CRECI-SP' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Financiamento Imobiliário', description: 'Simulação e assessoria em financiamento com os principais bancos' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Fotografia Profissional de Imóveis', description: 'Fotos, vídeos e tour virtual profissional' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Consultoria Imobiliária', description: 'Orientação especializada para investimento imobiliário' } },
    ],
  },
  knowsAbout: [
    ...
    'Busca de imóveis por inteligência artificial',
  ...
  award: 'CRECI-SP 279051 — Conselho Regional de Corretores de Imóveis de São Paulo',
}
