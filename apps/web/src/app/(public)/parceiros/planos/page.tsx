...
export const metadata: Metadata = {
  title: 'Dashboard Parceiro — Ferramentas Exclusivas | AgoraEncontrei',
  description:
  ...
  keywords: [
    'dashboard parceiro imobiliário',
    'ferramentas corretor franca sp',
    'roi leilão imóvel',
    'analytics imobiliário',
    'sentinela territorial',
    'leads qualificados imóveis',
    'agoraencontrei parceiros dashboard',
  ],
  openGraph: {
    title: 'Dashboard Parceiro | AgoraEncontrei',
    description:
      'Ferramentas exclusivas para corretores e imobiliárias: ROI de leilões, sentinela territorial e analytics em tempo real.',
    type: 'website',
    locale: 'pt_BR',
...
const PLANS = [
  {
    ...
    tools: [
      { name: 'Até 10 anúncios ativos', desc: 'Publique seus imóveis na plataforma', included: true },
      { name: 'Filtros de busca avançados', desc: 'Encontre oportunidades mais rápido', included: true },
      { name: 'Selo Verificado ✓', desc: 'Credibilidade e confiança para seus clientes', included: true },
      { name: 'Link WhatsApp direto', desc: 'Clientes entram em contato sem intermediários', included: true },
      { name: 'Topo das buscas por bairro', desc: 'Apareça primeiro nas buscas da região', included: true },
      { name: 'I.A. de ROI e alertas', desc: 'Análises inteligentes de oportunidades', included: false },
      { name: 'Edição de fotos com I.A.', desc: 'Melhore suas fotos automaticamente', included: false },
      { name: 'Destaque no mapa de busca', desc: 'Pin destacado no mapa interativo', included: false },
    ],
  },
  {
    id: 'MODERADO',
    ...
    ctaStyle: 'bg-[#C9A84C] text-[#1B2B5B] hover:bg-[#b8943d]',
    tools: [
      { name: 'Até 30 anúncios ativos', desc: 'Portfólio amplo para mais vendas', included: true },
      { name: 'I.A. de ROI (10 análises/mês)', desc: 'Score de oportunidade em leilões', included: true },
      { name: 'Alertas de oportunidades', desc: 'Notificações de leilões com desconto > 40%', included: true },
      { name: 'Selo Verificado ✓', desc: 'Credibilidade e confiança para seus clientes', included: true },
      { name: 'Topo das buscas por bairro', desc: 'Apareça primeiro nas buscas da região', included: true },
      { name: 'Dashboard de analytics', desc: 'Visualizações, cliques e impressões', included: true },
      { name: 'Edição de fotos com I.A.', desc: 'Melhore suas fotos automaticamente', included: false },
      { name: 'Banner em condomínios de luxo', desc: 'Exclusividade em edifícios premium', included: false },
    ],
  },
  {
    id: 'VIP',
    ...
    tools: [
      { name: 'Até 100 anúncios ativos', desc: 'Portfólio completo para grandes operações', included: true },
      { name: 'I.A. Ilimitada (ROI + Fotos + Dossiês)', desc: 'Todas as ferramentas de inteligência', included: true },
      { name: 'Edição de fotos com I.A.', desc: 'Fotos profissionais em 1 clique', included: true },
      { name: 'Alertas em tempo real', desc: 'Oportunidades de leilão e mercado', included: true },
      { name: 'Banner em condomínios de luxo', desc: 'Exclusividade em edifícios premium', included: true },
      { name: 'Destaque no mapa de busca', desc: 'Pin destacado no mapa interativo', included: true },
      { name: 'Relatórios mensais de desempenho', desc: 'PDF com performance e ROI', included: true },
      { name: 'Sentinela territorial', desc: 'Monitoramento exclusivo de bairros', included: true },
    ],
  },
]
