...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no PARQUE PROGRESSO  São 2 em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no PARQUE PROGRESSO  São 2 com atendimento personalizado.',
  keywords: [
