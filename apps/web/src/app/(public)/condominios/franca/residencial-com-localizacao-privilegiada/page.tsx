...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL COM LOCALIZAÇÃO PRIVILEGIADA em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL COM LOCALIZAÇÃO PRIVILEGIADA com atendimento personalizado.',
  keywords: [
