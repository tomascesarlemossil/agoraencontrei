...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no Residencial TELLINI  Medindo 10x25  Excelente em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no Residencial TELLINI  Medindo 10x25  Excelente com atendimento personalizado.',
  keywords: [
