...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no VILLAGE SANTA GEORGINA em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no VILLAGE SANTA GEORGINA com atendimento personalizado.',
  keywords: [
