...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL POLO CLUB  Terreno em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL POLO CLUB  Terreno com atendimento personalizado.',
  keywords: [
