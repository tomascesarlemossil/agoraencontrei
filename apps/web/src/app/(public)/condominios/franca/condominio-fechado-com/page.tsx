...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no Condomínio Fechado com em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no Condomínio Fechado com com atendimento personalizado.',
  keywords: [
