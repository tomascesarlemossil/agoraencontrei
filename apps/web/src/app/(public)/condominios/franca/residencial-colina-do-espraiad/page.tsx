...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL COLINA DO ESPRAIAD em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL COLINA DO ESPRAIAD com atendimento personalizado.',
  keywords: [
