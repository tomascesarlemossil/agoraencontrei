...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL FLAMBOYANT   Com em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL FLAMBOYANT   Com com atendimento personalizado.',
  keywords: [
