...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL DISPONIVEL PARÀ VENDA NA em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL DISPONIVEL PARÀ VENDA NA com atendimento personalizado.',
  keywords: [
