...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL CHAMPAGNAT NO JARDIM CONSOLAÇÃO em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL CHAMPAGNAT NO JARDIM CONSOLAÇÃO com atendimento personalizado.',
  keywords: [
