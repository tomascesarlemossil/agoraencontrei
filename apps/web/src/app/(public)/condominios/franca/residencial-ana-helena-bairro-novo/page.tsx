...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no RESIDENCIAL ANA HELENA  Bairro novo em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no RESIDENCIAL ANA HELENA  Bairro novo com atendimento personalizado.',
  keywords: [
