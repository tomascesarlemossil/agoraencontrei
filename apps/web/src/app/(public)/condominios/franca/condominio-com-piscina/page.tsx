...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no condomínio com piscina em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no condomínio com piscina com atendimento personalizado.',
  keywords: [
