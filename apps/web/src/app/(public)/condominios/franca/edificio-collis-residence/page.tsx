...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no EDIFÍCIO COLLIS RESIDENCE em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no EDIFÍCIO COLLIS RESIDENCE com atendimento personalizado.',
  keywords: [
