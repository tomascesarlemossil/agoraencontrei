...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no Edifício Terraço de Itália em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no Edifício Terraço de Itália com atendimento personalizado.',
  keywords: [
