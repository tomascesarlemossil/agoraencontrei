...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no EDIFÍCIO SPAZIO FRATELLI em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no EDIFÍCIO SPAZIO FRATELLI com atendimento personalizado.',
  keywords: [
