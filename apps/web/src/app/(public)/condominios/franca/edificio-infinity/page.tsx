...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no Edifício Infinity em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no Edifício Infinity com atendimento personalizado.',
  keywords: [
