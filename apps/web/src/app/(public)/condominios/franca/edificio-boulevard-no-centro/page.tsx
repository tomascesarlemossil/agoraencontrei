...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no EDIFÍCIO BOULEVARD NO CENTRO em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no EDIFÍCIO BOULEVARD NO CENTRO com atendimento personalizado.',
  keywords: [
