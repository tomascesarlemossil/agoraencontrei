...
export const metadata: Metadata = {
  ...
  description: 'Casas à venda e para alugar no EDIFÍCIO CLIMENE NOVELINO NOVOS em Franca/SP. Imobiliária Lemos — 22 anos de tradição.. Encontre o imóvel ideal no EDIFÍCIO CLIMENE NOVELINO NOVOS com atendimento personalizado.',
  keywords: [
