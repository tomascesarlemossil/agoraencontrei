      ...
      <section className="bg-gradient-to-br from-[#143A1F] to-[#0f1c3a] text-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href={`/imoveis?city=Belo Horizonte`} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm" style={{ background: '#C9A84C', color: '#143A1F' }}>
