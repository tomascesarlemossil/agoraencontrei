    ...
    <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl p-5 border border-gray-100 flex gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: '#143A1F15', color: '#143A1F' }}>
                {item.icon}
              </div>
              <div>
                <p className="font-bold text-sm" style={{ color: '#143A1F' }}>{item.title}</p>
            ...
            {properties.map((p: any) => (
              <Link key={p.id} href={`/imoveis/${p.slug}`}
                ...
                <div className="relative h-44 overflow-hidden bg-gray-100">
                  ...
                  <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full text-xs font-bold text-white" style={{ background: '#C9A84C', color: '#143A1F' }}>
                    Venda
                  </div>
                </div>
                <div className="p-4">
      ...
      <section className="bg-white border-t py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="text-lg font-bold mt-6 mb-2" style={{ color: '#143A1F' }}>Melhores bairros para comprar casa em Franca</h3>
          <p className="text-gray-600 mb-4">
          ...
          <h3 className="text-lg font-bold mt-6 mb-2" style={{ color: '#143A1F' }}>Financiamento imobiliário em Franca</h3>
          <p className="text-gray-600 mb-4">
          ...
          <h3 className="text-lg font-bold mt-6 mb-2" style={{ color: '#143A1F' }}>Por que comprar com a Imobiliária Lemos</h3>
