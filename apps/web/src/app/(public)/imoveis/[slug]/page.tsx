              ...
              <div className="p-5">
                ...
                <div className="space-y-2.5">
                  ...
                  <a href={`tel:${broker?.phone ?? '1637230045'}`}
                    ...
                    style={{ borderColor: '#1B2B5B', color: '#1B2B5B', backgroundColor: 'transparent' }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = '#1B2B5B'; (e.currentTarget as HTMLElement).style.color = 'white' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'transparent'; (e.currentTarget as HTMLElement).style.color = '#1B2B5B' }}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
