...
export async function generateMetadata(props: { params: Promise<{ cidade: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${WEB_URL}/imoveis-para-alugar/${params.cidade}` },
  }
}
      ...
      <section className="bg-gradient-to-br from-[#1B2B5B] to-[#0f1c3a] text-white py-14 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href={`/imoveis?city=${city.name}&purpose=RENT`} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm" style={{ background: '#C9A84C', color: '#1B2B5B' }}><Search className="w-4 h-4" /> Buscar</Link>
