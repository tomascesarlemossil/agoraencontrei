  ...
  if (step === 'upload') {
    return (
      <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #f8f7f4 0%, #fff 100%)' }}>
        {/* Hero */}
        <div className="py-16 px-4 text-center" style={{ background: 'linear-gradient(135deg, #143A1F 0%, #2d4a8a 100%)' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {FILTERS.map(f => (
                <button
                  ...
                  style={{
                    borderColor: selectedFilter === f.id ? '#143A1F' : '#e0dbd0',
                    backgroundColor: selectedFilter === f.id ? 'rgba(20,58,31,0.04)' : 'white',
                  }}
                >
                  <div className="text-3xl mb-2">{f.emoji}</div>
                  <div className="font-bold text-sm mb-1" style={{ color: '#143A1F' }}>{f.name}</div>
                  <div className="text-xs text-gray-500">{f.description}</div>
                  {selectedFilter === f.id && (
                    <div className="mt-2 flex items-center gap-1 text-xs font-bold" style={{ color: '#143A1F' }}>
      ...
      <div className="min-h-screen py-12 px-4" style={{ background: 'linear-gradient(135deg, #f8f7f4 0%, #fff 100%)' }}>
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4" style={{ background: 'rgba(20,58,31,0.08)' }}>
              <CreditCard className="w-7 h-7" style={{ color: '#143A1F' }} />
            </div>
            <h1 className="text-2xl font-bold mb-2" style={{ color: '#143A1F', fontFamily: 'Georgia, serif' }}>
              Pagamento
            </h1>
            ...
            {!payData ? (
              <>
                <div className="mb-6 p-4 rounded-2xl text-center" style={{ background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.3)' }}>
                  ...
                  <p className="text-4xl font-bold mt-1" style={{ color: '#143A1F' }}>R$ 10,00</p>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center gap-2 p-3 rounded-xl border text-xs font-mono break-all" style={{ borderColor: '#e0dbd0', background: '#f9f9f7' }}>
                        ...
                        <button
                          ...
                          style={{ background: copied ? '#16a34a' : '#143A1F', color: 'white' }}
                        >
    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-12 px-4" style={{ background: 'linear-gradient(135deg, #f8f7f4 0%, #fff 100%)' }}>
        <div className="max-w-sm w-full text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-6" style={{ background: 'rgba(20,58,31,0.08)' }}>
            <Sparkles className="w-10 h-10" style={{ color: '#143A1F' }} />
          </div>
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#143A1F', fontFamily: 'Georgia, serif' }}>
            Editando suas fotos...
          </h2>
          ...
          <div className="w-full bg-gray-100 rounded-full h-3 mb-3">
            <div
              ...
              style={{ width: `${processProgress}%`, background: 'linear-gradient(90deg, #143A1F, #C9A84C)' }}
            />
          </div>
          <p className="text-sm font-bold" style={{ color: '#143A1F' }}>{processProgress}%</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen py-12 px-4" style={{ background: 'linear-gradient(135deg, #f8f7f4 0%, #fff 100%)' }}>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold mb-2" style={{ color: '#143A1F', fontFamily: 'Georgia, serif' }}>
            ...
            <div key={i} className="relative group rounded-2xl overflow-hidden bg-gray-100 aspect-square border" style={{ borderColor: '#e0dbd0' }}>
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                <button
                  ...
                  style={{ background: 'rgba(20,58,31,0.9)' }}
                >
        ...
        <div className="mt-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a
              ...
              style={{ borderColor: '#e0dbd0', color: '#143A1F' }}
            >
