...
em Franca/SP
          ...
          <p className="text-white/70 text-lg mb-6 max-w-2xl mx-auto">Assessoria jurídica imobiliária em Franca/SP: contratos, escrituras, regularização e muito mais. Segurança em cada transação.</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <a href="https://wa.me/5516981010004?text=Olá! Preciso de ajuda com Direito Imobiliário em Franca/SP em Franca/SP."
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl p-8 border space-y-6">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Contratos imobiliários em Franca/SP</h3>
              <p className="text-gray-600 text-sm leading-relaxed">Todo negócio imobiliário em Franca/SP deve ser formalizado por contrato. A Imobiliária Lemos elabora contratos de compra e venda, locação, permuta e comodato com segurança jurídica, protegendo os interesses de compradores, vendedores e locatários.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Escritura e registro de imóvel em Franca</h3>
              <p className="text-gray-600 text-sm leading-relaxed">A escritura pública e o registro em cartório são obrigatórios para transferir a propriedade de um imóvel em Franca/SP. O processo envolve o Cartório de Notas (escritura) e o Cartório de Registro de Imóveis (registro). Nossa equipe orienta você em cada etapa.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Regularização de imóveis em Franca/SP</h3>
              <p className="text-gray-600 text-sm leading-relaxed">Muitos imóveis em Franca/SP têm pendências documentais: escritura em nome de falecido, construção não averbada, dívidas de IPTU ou condomínio. A Imobiliária Lemos pode indicar advogados especializados em regularização imobiliária para resolver essas situações.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Locação e despejo em Franca/SP</h3>
              <p className="text-gray-600 text-sm leading-relaxed">A Lei do Inquilinato (Lei 8.245/91) regula as locações em Franca/SP. Questões como reajuste de aluguel, rescisão contratual, despejo por falta de pagamento e renovação de contrato são tratadas pela nossa equipe com conhecimento técnico e jurídico.</p>
            </div>
        </div>
      </section>
