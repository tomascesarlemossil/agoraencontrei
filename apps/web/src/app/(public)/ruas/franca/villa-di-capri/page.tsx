...
export const metadata: Metadata = {
  title: 'Imóveis na Villa Di Capri, NÚCLEO AGRÍCOLA ALPHA — Franca/SP | Imobiliária Lemos',
  description: 'Casas, apartamentos e terrenos na Villa Di Capri em NÚCLEO AGRÍCOLA ALPHA, Franca/SP. Imobiliária Lemos — 22 anos de tradição. CRECI 279051.',
  keywords: [
    'imóveis villa di capri franca sp',
    'casas villa di capri franca',
    'apartamentos villa di capri franca',
    'comprar imóvel villa di capri franca sp',
    'alugar villa di capri franca sp',
    'imobiliária lemos villa di capri',
    'villa di capri franca sp imóveis',
    'imóveis núcleo agrícola alpha franca sp',
  ],
  openGraph: {
    title: 'OG_Imóveis na Villa Di Capri, NÚCLEO AGRÍCOLA ALPHA — Franca/SP | Imobiliária Lemos',
    description: 'Encontre casas, apartamentos e terrenos na Villa Di Capri em Franca/SP.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei — Imobiliária Lemos',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/ruas/franca/villa-di-capri' },
...
const SCHEMA = {
  ...
  name: 'Imóveis na Villa Di Capri — Franca/SP',
  description: 'Imóveis disponíveis na Villa Di Capri em Franca, São Paulo. Imobiliária Lemos — CRECI 279051.',
  url: 'https://www.agoraencontrei.com.br/ruas/franca/villa-di-capri',
  provider: {
...
async function fetchProperties() {
  try {
    const res = await fetch(
      `${API_URL}/api/v1/public/properties?city=Franca&street=${encodeURIComponent('VILLA DI CAPRI')}&limit=12&status=ACTIVE&sortBy=createdAt&sortOrder=desc`,
      { next: { revalidate: 600 } }
    )
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">
                  Imóveis na <span className="text-yellow-400">Villa Di Capri</span>
                </h1>
          ...
          {properties.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">
                Imóveis disponíveis na Villa Di Capri
              </h2>
              ...
              <div className="text-center">
                <Link href={`/imoveis/em/franca?street=${encodeURIComponent('VILLA DI CAPRI')}`}
                  ...
                  Ver todos os imóveis na Villa Di Capri <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </>
          ) : (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-700 mb-2">
                Busque imóveis na Villa Di Capri
              </h2>
              <p className="text-gray-500 mb-6 max-w-md mx-auto">
                Consulte nossa equipe para encontrar imóveis disponíveis na Villa Di Capri,
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/5516937230045?text=Olá!%20Tenho%20interesse%20em%20imóveis%20na%20Villa%20Di%20Capri%20em%20Franca/SP"
        ...
        <section className="bg-white py-12 border-t">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Sobre a Villa Di Capri em Franca/SP
            </h2>
            <div className="prose max-w-none text-gray-600">
              <p>
                A <strong>Villa Di Capri</strong> está localizada no bairro <strong>NÚCLEO AGRÍCOLA ALPHA</strong> em <strong>Franca/SP</strong>,
              ...
              <p>
                ...
                é especialista em imóveis na Villa Di Capri e região. Nossa equipe de corretores conhece
                profundamente cada rua e bairro de Franca, garantindo o melhor atendimento na busca pelo
                seu imóvel ideal.
              </p>
              <p>
                Seja para <strong>comprar</strong> ou <strong>alugar</strong> um imóvel na Villa Di Capri,
