...
export const metadata: Metadata = {
  title: 'Imóveis na Lioba Ferreira Duzzi, PORTINARI — Franca/SP | Imobiliária Lemos',
  description: 'Casas, apartamentos e terrenos na Lioba Ferreira Duzzi em PORTINARI, Franca/SP. Imobiliária Lemos — 22 anos de tradição. CRECI 279051.',
  keywords: [
    'imóveis lioba ferreira duzzi franca sp',
    'casas lioba ferreira duzzi franca',
    'apartamentos lioba ferreira duzzi franca',
    'comprar imóvel lioba ferreira duzzi franca sp',
    'alugar lioba ferreira duzzi franca sp',
    'imobiliária lemos lioba ferreira duzzi',
    'lioba ferreira duzzi franca sp imóveis',
    'imóveis portinari franca sp',
  ],
  openGraph: {
    title: 'OG_Imóveis na Lioba Ferreira Duzzi, PORTINARI — Franca/SP | Imobiliária Lemos',
    description: 'Encontre casas, apartamentos e terrenos na Lioba Ferreira Duzzi em Franca/SP.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei — Imobiliária Lemos',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/ruas/franca/lioba-ferreira-duzzi' },
...
const SCHEMA = {
  ...
  name: 'Imóveis na Lioba Ferreira Duzzi — Franca/SP',
  description: 'Imóveis disponíveis na Lioba Ferreira Duzzi em Franca, São Paulo. Imobiliária Lemos — CRECI 279051.',
  url: 'https://www.agoraencontrei.com.br/ruas/franca/lioba-ferreira-duzzi',
  provider: {
...
async function fetchProperties() {
  try {
    const res = await fetch(
      `${API_URL}/api/v1/public/properties?city=Franca&street=${encodeURIComponent('LIOBA FERREIRA DUZZI')}&limit=12&status=ACTIVE&sortBy=createdAt&sortOrder=desc`,
      { next: { revalidate: 600 } }
    )
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16">
          <div className="max-w-6xl mx-auto px-4">
            <nav className="text-sm text-blue-200 mb-4 flex items-center gap-2 flex-wrap">
              ...
              <><span>/</span><Link href="/bairros/franca/portinari" className="hover:text-white">PORTINARI</Link></>
              <span>/</span>
              <span className="text-white">Lioba Ferreira Duzzi</span>
            </nav>
            <div className="flex items-start gap-4">
              <MapPin className="w-10 h-10 text-yellow-400 flex-shrink-0 mt-1" />
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">
                  Imóveis na <span className="text-yellow-400">Lioba Ferreira Duzzi</span>
                </h1>
                <p className="text-blue-100 text-lg">
                  PORTINARI · Franca/SP · {total > 0 ? `${total} imóveis disponíveis` : 'Consulte disponibilidade'}
                </p>
              </div>
            </div>
          </div>
          ...
          {properties.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">
                Imóveis disponíveis na Lioba Ferreira Duzzi
              </h2>
              ...
              <div className="text-center">
                <Link href={`/imoveis/em/franca?street=${encodeURIComponent('LIOBA FERREIRA DUZZI')}`}
                  ...
                  Ver todos os imóveis na Lioba Ferreira Duzzi <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </>
          ) : (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-700 mb-2">
                Busque imóveis na Lioba Ferreira Duzzi
              </h2>
              <p className="text-gray-500 mb-6 max-w-md mx-auto">
                Consulte nossa equipe para encontrar imóveis disponíveis na Lioba Ferreira Duzzi,
                PORTINARI em Franca/SP.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/5516937230045?text=Olá!%20Tenho%20interesse%20em%20imóveis%20na%20Lioba%20Ferreira%20Duzzi%20em%20Franca/SP"
        ...
        <section className="bg-white py-12 border-t">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Sobre a Lioba Ferreira Duzzi em Franca/SP
            </h2>
            <div className="prose max-w-none text-gray-600">
              <p>
                A <strong>Lioba Ferreira Duzzi</strong> está localizada no bairro <strong>PORTINARI</strong> em <strong>Franca/SP</strong>,
              ...
              <p>
                ...
                é especialista em imóveis na Lioba Ferreira Duzzi e região. Nossa equipe de corretores conhece
                profundamente cada rua e bairro de Franca, garantindo o melhor atendimento na busca pelo
                seu imóvel ideal.
              </p>
              <p>
                Seja para <strong>comprar</strong> ou <strong>alugar</strong> um imóvel na Lioba Ferreira Duzzi,
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/bairros/franca/portinari" className="bg-white border border-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm hover:bg-blue-50 hover:border-blue-300 transition-colors">PORTINARI</Link>
