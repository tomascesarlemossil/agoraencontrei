...
export const metadata: Metadata = {
  title: 'Imóveis na Valtemir Dantes, santa teresinha — Franca/SP | Imobiliária Lemos',
  description: 'Casas, apartamentos e terrenos na Valtemir Dantes em santa teresinha, Franca/SP. Imobiliária Lemos — 22 anos de tradição. CRECI 279051.',
  keywords: [
    'imóveis valtemir dantes franca sp',
    'casas valtemir dantes franca',
    'apartamentos valtemir dantes franca',
    'comprar imóvel valtemir dantes franca sp',
    'alugar valtemir dantes franca sp',
    'imobiliária lemos valtemir dantes',
    'valtemir dantes franca sp imóveis',
    'imóveis santa teresinha franca sp',
  ],
  openGraph: {
    title: 'OG_Imóveis na Valtemir Dantes, santa teresinha — Franca/SP | Imobiliária Lemos',
    description: 'Encontre casas, apartamentos e terrenos na Valtemir Dantes em Franca/SP.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei — Imobiliária Lemos',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/ruas/franca/valtemir-dantes' },
...
const SCHEMA = {
  ...
  name: 'Imóveis na Valtemir Dantes — Franca/SP',
  description: 'Imóveis disponíveis na Valtemir Dantes em Franca, São Paulo. Imobiliária Lemos — CRECI 279051.',
  url: 'https://www.agoraencontrei.com.br/ruas/franca/valtemir-dantes',
  provider: {
...
async function fetchProperties() {
  try {
    const res = await fetch(
      `${API_URL}/api/v1/public/properties?city=Franca&street=${encodeURIComponent('valtemir dantes')}&limit=12&status=ACTIVE&sortBy=createdAt&sortOrder=desc`,
      { next: { revalidate: 600 } }
    )
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16">
          <div className="max-w-6xl mx-auto px-4">
            <nav className="text-sm text-blue-200 mb-4 flex items-center gap-2 flex-wrap">
              ...
              <><span>/</span><Link href="/bairros/franca/santa-teresinha" className="hover:text-white">santa teresinha</Link></>
              <span>/</span>
              <span className="text-white">Valtemir Dantes</span>
            </nav>
            <div className="flex items-start gap-4">
              <MapPin className="w-10 h-10 text-yellow-400 flex-shrink-0 mt-1" />
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">
                  Imóveis na <span className="text-yellow-400">Valtemir Dantes</span>
                </h1>
                <p className="text-blue-100 text-lg">
                  santa teresinha · Franca/SP · {total > 0 ? `${total} imóveis disponíveis` : 'Consulte disponibilidade'}
                </p>
              </div>
            </div>
          </div>
          ...
          {properties.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">
                Imóveis disponíveis na Valtemir Dantes
              </h2>
              ...
              <div className="text-center">
                <Link href={`/imoveis/em/franca?street=${encodeURIComponent('valtemir dantes')}`}
                  ...
                  Ver todos os imóveis na Valtemir Dantes <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </>
          ) : (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-700 mb-2">
                Busque imóveis na Valtemir Dantes
              </h2>
              <p className="text-gray-500 mb-6 max-w-md mx-auto">
                Consulte nossa equipe para encontrar imóveis disponíveis na Valtemir Dantes,
                santa teresinha em Franca/SP.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/5516937230045?text=Olá!%20Tenho%20interesse%20em%20imóveis%20na%20Valtemir%20Dantes%20em%20Franca/SP"
        ...
        <section className="bg-white py-12 border-t">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Sobre a Valtemir Dantes em Franca/SP
            </h2>
            <div className="prose max-w-none text-gray-600">
              <p>
                A <strong>Valtemir Dantes</strong> está localizada no bairro <strong>santa teresinha</strong> em <strong>Franca/SP</strong>,
              ...
              <p>
                ...
                é especialista em imóveis na Valtemir Dantes e região. Nossa equipe de corretores conhece
                profundamente cada rua e bairro de Franca, garantindo o melhor atendimento na busca pelo
                seu imóvel ideal.
              </p>
              <p>
                Seja para <strong>comprar</strong> ou <strong>alugar</strong> um imóvel na Valtemir Dantes,
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/bairros/franca/santa-teresinha" className="bg-white border border-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm hover:bg-blue-50 hover:border-blue-300 transition-colors">santa teresinha</Link>
