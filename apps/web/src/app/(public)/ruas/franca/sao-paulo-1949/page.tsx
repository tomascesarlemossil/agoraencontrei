...
export const metadata: Metadata = {
  title: 'Imóveis na Sao Paulo 1949, VILA APARECIDA — Franca/SP | Imobiliária Lemos',
  description: 'Casas, apartamentos e terrenos na Sao Paulo 1949 em VILA APARECIDA, Franca/SP. Imobiliária Lemos — 22 anos de tradição. CRECI 279051.',
  keywords: [
    'imóveis sao paulo 1949 franca sp',
    'casas sao paulo 1949 franca',
    'apartamentos sao paulo 1949 franca',
    'comprar imóvel sao paulo 1949 franca sp',
    'alugar sao paulo 1949 franca sp',
    'imobiliária lemos sao paulo 1949',
    'sao paulo 1949 franca sp imóveis',
    'imóveis vila aparecida franca sp',
  ],
  openGraph: {
    title: 'OG_Imóveis na Sao Paulo 1949, VILA APARECIDA — Franca/SP | Imobiliária Lemos',
    description: 'Encontre casas, apartamentos e terrenos na Sao Paulo 1949 em Franca/SP.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei — Imobiliária Lemos',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/ruas/franca/sao-paulo-1949' },
...
const SCHEMA = {
  ...
  name: 'Imóveis na Sao Paulo 1949 — Franca/SP',
  description: 'Imóveis disponíveis na Sao Paulo 1949 em Franca, São Paulo. Imobiliária Lemos — CRECI 279051.',
  url: 'https://www.agoraencontrei.com.br/ruas/franca/sao-paulo-1949',
  provider: {
...
async function fetchProperties() {
  try {
    const res = await fetch(
      `${API_URL}/api/v1/public/properties?city=Franca&street=${encodeURIComponent('SAO PAULO 1949')}&limit=12&status=ACTIVE&sortBy=createdAt&sortOrder=desc`,
      { next: { revalidate: 600 } }
    )
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16">
          <div className="max-w-6xl mx-auto px-4">
            <nav className="text-sm text-blue-200 mb-4 flex items-center gap-2 flex-wrap">
              ...
              <span>/</span>
              <span className="text-white">Sao Paulo 1949</span>
            </nav>
            <div className="flex items-start gap-4">
              <MapPin className="w-10 h-10 text-yellow-400 flex-shrink-0 mt-1" />
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">
                  Imóveis na <span className="text-yellow-400">Sao Paulo 1949</span>
                </h1>
          ...
          {properties.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">
                Imóveis disponíveis na Sao Paulo 1949
              </h2>
              ...
              <div className="text-center">
                <Link href={`/imoveis/em/franca?street=${encodeURIComponent('SAO PAULO 1949')}`}
                  ...
                  Ver todos os imóveis na Sao Paulo 1949 <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </>
          ) : (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-700 mb-2">
                Busque imóveis na Sao Paulo 1949
              </h2>
              <p className="text-gray-500 mb-6 max-w-md mx-auto">
                Consulte nossa equipe para encontrar imóveis disponíveis na Sao Paulo 1949,
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/5516937230045?text=Olá!%20Tenho%20interesse%20em%20imóveis%20na%20Sao%20Paulo%201949%20em%20Franca/SP"
        ...
        <section className="bg-white py-12 border-t">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Sobre a Sao Paulo 1949 em Franca/SP
            </h2>
            <div className="prose max-w-none text-gray-600">
              <p>
                A <strong>Sao Paulo 1949</strong> está localizada no bairro <strong>VILA APARECIDA</strong> em <strong>Franca/SP</strong>,
              ...
              <p>
                ...
                é especialista em imóveis na Sao Paulo 1949 e região. Nossa equipe de corretores conhece
                profundamente cada rua e bairro de Franca, garantindo o melhor atendimento na busca pelo
                seu imóvel ideal.
              </p>
              <p>
                Seja para <strong>comprar</strong> ou <strong>alugar</strong> um imóvel na Sao Paulo 1949,
