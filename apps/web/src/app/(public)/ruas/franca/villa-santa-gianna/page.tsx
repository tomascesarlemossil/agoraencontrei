...
export const metadata: Metadata = {
  title: 'Imóveis na Villa Santa Gianna, VILLA SANTA GIANNA — Franca/SP | Imobiliária Lemos',
  description: 'Casas, apartamentos e terrenos na Villa Santa Gianna em VILLA SANTA GIANNA, Franca/SP. Imobiliária Lemos — 22 anos de tradição. CRECI 279051.',
  keywords: [
    'imóveis villa santa gianna franca sp',
    'casas villa santa gianna franca',
    'apartamentos villa santa gianna franca',
    'comprar imóvel villa santa gianna franca sp',
    'alugar villa santa gianna franca sp',
    'imobiliária lemos villa santa gianna',
    'villa santa gianna franca sp imóveis',
    'imóveis villa santa gianna franca sp',
  ],
  openGraph: {
    title: 'OG_Imóveis na Villa Santa Gianna, VILLA SANTA GIANNA — Franca/SP | Imobiliária Lemos',
    description: 'Encontre casas, apartamentos e terrenos na Villa Santa Gianna em Franca/SP.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei — Imobiliária Lemos',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/ruas/franca/villa-santa-gianna' },
...
const SCHEMA = {
  ...
  name: 'Imóveis na Villa Santa Gianna — Franca/SP',
  description: 'Imóveis disponíveis na Villa Santa Gianna em Franca, São Paulo. Imobiliária Lemos — CRECI 279051.',
  url: 'https://www.agoraencontrei.com.br/ruas/franca/villa-santa-gianna',
  provider: {
...
async function fetchProperties() {
  try {
    const res = await fetch(
      `${API_URL}/api/v1/public/properties?city=Franca&street=${encodeURIComponent('Villa Santa Gianna')}&limit=12&status=ACTIVE&sortBy=createdAt&sortOrder=desc`,
      { next: { revalidate: 600 } }
    )
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">
                  Imóveis na <span className="text-yellow-400">Villa Santa Gianna</span>
                </h1>
          ...
          {properties.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">
                Imóveis disponíveis na Villa Santa Gianna
              </h2>
              ...
              <div className="text-center">
                <Link href={`/imoveis/em/franca?street=${encodeURIComponent('Villa Santa Gianna')}`}
                  ...
                  Ver todos os imóveis na Villa Santa Gianna <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </>
          ) : (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-700 mb-2">
                Busque imóveis na Villa Santa Gianna
              </h2>
              <p className="text-gray-500 mb-6 max-w-md mx-auto">
                Consulte nossa equipe para encontrar imóveis disponíveis na Villa Santa Gianna,
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="https://wa.me/5516937230045?text=Olá!%20Tenho%20interesse%20em%20imóveis%20na%20Villa%20Santa%20Gianna%20em%20Franca/SP"
        ...
        <section className="bg-white py-12 border-t">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Sobre a Villa Santa Gianna em Franca/SP
            </h2>
            <div className="prose max-w-none text-gray-600">
              <p>
                A <strong>Villa Santa Gianna</strong> está localizada no bairro <strong>VILLA SANTA GIANNA</strong> em <strong>Franca/SP</strong>,
              ...
              <p>
                ...
                é especialista em imóveis na Villa Santa Gianna e região. Nossa equipe de corretores conhece
                profundamente cada rua e bairro de Franca, garantindo o melhor atendimento na busca pelo
                seu imóvel ideal.
              </p>
              <p>
                Seja para <strong>comprar</strong> ou <strong>alugar</strong> um imóvel na Villa Santa Gianna,
