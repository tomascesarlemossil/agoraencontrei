...
export const metadata: Metadata = {
  title: 'Imóveis em Curitiba/PR — Venda, Aluguel e Leilões | AgoraEncontrei',
  description: 'Encontre imóveis em Curitiba/PR. Casas, apartamentos e terrenos à venda e para alugar. Leilões com até 50% de desconto. Marketplace imobiliário #1 do Brasil.',
  keywords: [
    'imóveis curitiba pr', 'casas à venda curitiba', 'apartamentos curitiba',
    'aluguel curitiba', 'leilão imóveis curitiba', 'terrenos curitiba',
    'imobiliária curitiba', 'comprar imóvel curitiba pr',
  ],
  openGraph: {
    title: 'Imóveis em Curitiba/PR | AgoraEncontrei',
    description: 'Marketplace imobiliário com imóveis à venda, aluguel e leilões em Curitiba/PR.',
    type: 'website', locale: 'pt_BR', siteName: 'AgoraEncontrei',
  },
  alternates: { canonical: 'https://www.agoraencontrei.com.br/imoveis-curitiba-pr' },
}

const BAIRROS = ['Batel', 'Água', 'Verde', 'Ecoville', 'Cabral', 'Juvevê', 'Cristo', 'Rei', 'Centro', 'Cívico', 'Santa', 'Felicidade', 'Mercês', 'Bigorrilho', ]
...
export default async function CityPage() {
  ...
  const schema = {
    ...
    name: 'AgoraEncontrei — Imóveis em Curitiba/PR',
    url: 'https://www.agoraencontrei.com.br/imoveis-curitiba-pr',
    areaServed: { '@type': 'City', name: 'Curitiba', containedInPlace: { '@type': 'State', name: 'PR' } },
    description: 'Capital ecológica do Brasil. Planejamento urbano referência mundial. Alto IDH.',
  }
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-[#1B2B5B] to-[#0f1c3a] text-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4" style={{ fontFamily: 'Georgia, serif' }}>
            Imóveis em <span style={{ color: '#C9A84C' }}>Curitiba/PR</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href={`/custo-de-vida/curitiba-pr`} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm bg-white/10 text-white border border-white/20">
              📊 Custo de Vida
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-8 max-w-3xl mx-auto">
            <div className="bg-white/10 rounded-xl p-3 text-center">
              <div className="text-xl font-bold" style={{ color: '#C9A84C' }}>R$ 7.800</div>
              <div className="text-xs text-white/60">m² médio</div>
            </div>
            <div className="bg-white/10 rounded-xl p-3 text-center">
              <div className="text-xl font-bold" style={{ color: '#C9A84C' }}>R$ 2.200/mês</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-10">
        {/* Bairros */}
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-4">Bairros em Destaque — Curitiba</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {BAIRROS.map((b: string) => (
              <Link key={b} href={`/imoveis?city=Curitiba&neighborhood=${encodeURIComponent(b)}`}
        ...
        {properties.length > 0 && (
          <section>
            <h2 className="text-xl font-bold text-gray-800 mb-4">Imóveis à Venda em Curitiba</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <section className="bg-gradient-to-r from-[#1B2B5B] to-[#2d4a8a] rounded-2xl p-8 text-center text-white">
          ...
          <a href="https://wa.me/5516981010004?text=Olá! Procuro imóvel em Curitiba/PR."
