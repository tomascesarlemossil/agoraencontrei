    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 pb-16">
        ...
        {properties.length > 0 ? (
            ...
            {properties.map((p: any) => (
              <Link key={p.id} href={`/imoveis/${p.slug}`}
                ...
                <div className="relative h-44 overflow-hidden bg-gray-100">
                  ...
                  <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full text-xs font-bold text-[#143A1F]" style={{ background: '#C9A84C' }}>Venda</div>
                </div>
                <div className="p-4">
                  <p className="font-bold text-base mb-0.5" style={{ color: '#143A1F' }}>{fmtPrice(p)}</p>
          ...
          <div className="text-center py-12">
            <Link href="/imoveis?type=APARTMENT&purpose=SALE" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-white" style={{ background: '#143A1F' }}>
              Ver todos os apartamentos <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        )}
        {total > 12 && (
          <div className="text-center mt-8">
            <Link href="/imoveis?type=APARTMENT&purpose=SALE&city=Franca" className="inline-flex items-center gap-2 px-8 py-3 rounded-xl font-bold text-sm text-white" style={{ background: '#143A1F' }}>
      ...
      <section className="bg-white border-t py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-4" style={{ color: '#143A1F', fontFamily: 'Georgia, serif' }}>Comprar Apartamento em Franca/SP</h2>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2" style={{ color: '#143A1F' }}>Preços de apartamentos em Franca/SP</h3>
          <p className="text-gray-600 mb-4">
          ...
          <h3 className="text-lg font-bold mt-6 mb-2" style={{ color: '#143A1F' }}>Lançamentos imobiliários em Franca</h3>
