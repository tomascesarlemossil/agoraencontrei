    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Proprietário, inquilino, fiador ou interessado</p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Field label="CPF do cônjuge">
                <input
                  ...
                  onChange={e => set('spouseDocument', e.target.value)}
                  placeholder="000.000.000-00"
                  className={inputCls}
                />
              </Field>
          ...
          <div className="space-y-4">
            <Field label="Notas internas" hint="Visível apenas para a equipe">
              <textarea
                ...
                placeholder="Notas rápidas sobre o cliente..."
                rows={3}
            ...
            <Field label="Observações detalhadas" hint="Histórico, pendências, informações importantes">
              <textarea
                ...
                placeholder="Observações mais detalhadas sobre o cliente, histórico de relacionamento, pendências..."
                rows={4}
                className={inputCls + ' resize-none'}
              />
            </Field>
