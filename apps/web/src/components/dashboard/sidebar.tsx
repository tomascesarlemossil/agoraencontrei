...
const midNavItems = [
  ...
  { href: '/dashboard/integrations',        icon: Plug,             label: 'Integrações',   highlight: false },
  ...
  { href: '/dashboard/admin/repasses',        icon: Banknote,        label: 'Fila de Repasses',    highlight: true },
